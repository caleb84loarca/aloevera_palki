...
// partiendo de que ya tenemos creado un objecto DeptoData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new DeptoData());
...
//funcionando el palki
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new DeptoData());
	}
